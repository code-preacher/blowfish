...
<head>
    ...
    <title>ENCRYPTION AND DECRYPTION OF MEDICAL IMAGES USING BLOWFISH ALGORITHM</title>
    <!-- Custom CSS -->
        ...
        <div class="auth-box bg-light border-top border-secondary">
            <div id="loginform"><?php $lib->msg();?>
                <div class="text-center p-t-20 p-b-20">
                    <span style="color: #000;font-size: 18px;">ENCRYPTION AND DECRYPTION OF MEDICAL IMAGES USING BLOWFISH ALGORITHM</span>
                </div>
                <!-- Form -->
