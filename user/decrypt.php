...
if (isset($_POST) && isset($_POST['action'])) {
  ...
  if ($password === null) {
    $error .= 'Invalid Decryption Key or No Decryption Key  was entered<br>';
  }
  if ($action === null) {
  ...
  if ($error === '') {
    ...
    $filename  = preg_replace('#\.blowfish$#','',$filename);
    ...
    if ($error === '') {
      ...
      $d=(float)microtime(); 
  $execution_time = $s + $d ;
  $crud->addMatrix($_SESSION['id'],'decryption',$filename,$lib->formatBytes($_FILES['file']['size'], $precision = 2),$execution_time,$password);
    }
    }
                ...
                <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <form class="form col-12" enctype="multipart/form-data" method="post" id="form1" name="form1" auto-complete="off" action="decrypt.php">
                                        <div class="row p-b-30">
                                            ...
                                            <label>Please enter decryption key : </label>
                                             <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text bg-info text-white" id="basic-addon2"><i class="ti-lock"></i></span>
                                                </div>
                                                <input type="password" class="form-control form-control-lg" placeholder="Decryption Key" aria-label="Password" name="password" aria-describedby="basic-addon1" required>
                                            </div>
